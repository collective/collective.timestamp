...
class ITimestampingSettings(Interface):
    ...
    hashing_algorithm = schema.Choice(
        ...
        description=_("Choose the hashing algorithm that will be used for generating timestamps."),
    ...
    max_retries = schema.Int(
        ...
        description=_("The maximum number of attempts to retry timestamping in case of failure."),
        default=1,
        required=False,
    )
    ...
    initial_backoff_seconds = schema.Float(
        ...
        description=_("The initial time to wait before retrying a failed timestamping attempt."),
        default=1.0,
        required=False,
    )
    ...
    use_failover = schema.Bool(
        ...
        description=_("If enabled, additional timestamping services will be used if the main service is unavailable."),
        default=False,
        required=False,
    )
    ...
    failover_timestamping_service_urls = schema.List(
        ...
        description=_("These services will be used if the main service is unavailable."),
